...
int AAsterisco::getNodosCreados()
{
    return this->nodosCreados;
}

int AAsterisco::getNodosExpandidos()
{
...
string * AAsterisco::busquedaAAsterico()
{
    cout << "Inicia Busqueda AAsterisco" << endl;
    string * solucion;
...
void AAsterisco::crearHijos(Nodo nodoCabeza)
{
...
void AAsterisco::crearNodo(int posIHijo, int posJHijo, Nodo nodoCabeza)
{
    // Limites del entorno para crear nodos hijos
    int altoEntorno = this->miEntorno.getAlto();
    int anchoEntorno = this->miEntorno.getAncho();
...
estados AAsterisco::toEstado(int itemEntorno)
{
    estados estado;
    switch (itemEntorno)
    {
